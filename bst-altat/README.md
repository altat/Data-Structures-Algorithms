...
- hicpp-member-init: allow uninitialized members in Node
- cppcoreguidelines-pro-type-member-init: allow uninitialized members in Node
- cert-err58-cpp: allow construction of 'SS' with static storage duration
