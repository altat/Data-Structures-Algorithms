...
or
```
clang++ -std=c++14 -Wall -Wextra -Wno-sign-compare *.cpp -o ass3-graph
./ass3-graph
```
...
- Wsign-compare: allow comparison of integers of different signs: 'int' and 'std::vector::size_type' (aka 'unsigned long')
- google-runtime-references: allow non-const reference parameter
- modernize-loop-convert: allow for (Int I = 0; I < Vector.size(); I++)
